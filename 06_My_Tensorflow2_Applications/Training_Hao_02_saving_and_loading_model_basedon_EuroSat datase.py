# -*- coding: utf-8 -*-
"""Week 4 Programming Assignment.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1P4vvdFTDMxlOZkFhzBjm9cuqsjOY9tQs
...
def load_eurosat_data():
    data_dir = 'test_data_folder/EuroSAT/'
...
def get_checkpoint_every_epoch():
    ...
    checkpoint_every_epoch = ModelCheckpoint(filepath=checkpoint_path,save_weights_only=True,save_freq='epoch') 
...
def get_checkpoint_best_only():
    ...
    checkpoint_best_only = ModelCheckpoint(filepath=checkpoint_path,save_weights_only=True,save_best_only=True, monitor='val_accuracy', mode='max') 
